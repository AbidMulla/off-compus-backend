...
module.exports.sendForgotPasswordOtpEmail = async (email, otp = '1234') => {
    try {
        console.log('Preparing to send forgot password OTP email to:', email);
        ...
        <style type="text/css">
            ...
            .email-header { background-color: #dc3545; padding: 20px; text-align: center; color: #ffffff; }
            ...
            .email-content h2 { color: #dc3545; font-size: 20px; margin-bottom: 10px; text-align: center; }
            .email-content p { margin: 0 0 20px; text-align: justify; }
            .otp-code { font-size: 20px; color: #dc3545; font-weight: bold; text-align: center; margin: 20px 0; }
        ...
        <table>
            ...
            <td align="center">
                ...
                <tr>
                    ...
                    <h2>Hello,</h2>
                    <p>To reset your password, please use the One-Time Password (OTP) provided below. Kindly note that this OTP is valid for only 5 minutes.</p>
        ...
        console.log('Attempting to send forgot password OTP email...');
        ...
        console.log('=== Forgot Password OTP Email Process Completed ===\n');
        ...
        console.error('=== Forgot Password OTP Email Process Failed ===\n');
